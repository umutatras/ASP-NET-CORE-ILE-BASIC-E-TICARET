...
namespace ETicaretBasic.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList = _roleManager.Roles.Where(i => i.Name != Other.Role_Birey)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(Other.Role_Birey))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(Other.Role_Birey));
                    }
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "E-MAİL ONAYLAMA",
